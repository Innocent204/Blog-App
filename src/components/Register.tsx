                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="w-full pl-10 pr-3 py-2 bg-input-background border border-primary/20 rounded-md focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary text-foreground"
                    >
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    {role === 'admin' ? 'Admin users have full system access' : 'Editors can create and manage content'}
                  </p>
                </div>
                <div className="space-y-2">
